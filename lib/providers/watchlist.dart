...
class WatchListProvider extends ChangeNotifier{
  ...
  Future<List<Entry>> list() async{
    ...
    final watchlist= await ApiClient.database.listDocuments( collectionId: _collectionId);
    ...
    final filtered=entries.where((entry) => movieIds.contains(entry)).toList();
  ...
  Future<void> remove(Entry entry)async{
    ...
    await ApiClient.database.deleteDocument( collectionId: _collectionId, documentId: id);
    list();
  }
